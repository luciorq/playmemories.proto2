...
class MyMainWindow(QWidget):
    ...
    def createGuiWidgets(self):
        ...
        self.stillSizeCombo.setToolTip("Select photo size")
        ...
        self.shootModeCombo.setToolTip("Select shooting mode")
        ...
        self.connectMessage = QLabel("Device not connected!")
